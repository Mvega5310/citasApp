      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 z-10 shadow-sm">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-pink-500 hover:bg-pink-600 text-white text-sm font-semibold px-4 py-2 rounded-lg transition shadow-sm"
          >
        ...
        <div className="flex-1 p-4 md:p-8 mt-14 md:mt-0 max-w-3xl">
          ...
          <div className="mt-6 bg-blue-50 border border-blue-100 rounded-xl p-4">
            <p className="text-xs font-semibold text-blue-700 mb-2">Tipos de acceso</p>
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition"
                />
              </div>
              ...
              <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-100 rounded-lg mt-1">
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-pink-500 hover:bg-pink-600 text-white text-sm font-semibold rounded-lg transition disabled:opacity-60"
                >
                  {saving ? (
